...
import serial    #import serial to comunicate with arduino


serialDevFile = 'COM4'
ser=serial.Serial(serialDevFile, 9600, timeout=0)       ## create connection server between arduino and python
...
while True:
    wn.update()
    line = str(ser.readline())  ## read from info arduino
    dir = line[2]
    ...
    if head.distance(food) < 20:
        ser.write(b'B')         ## sending flag for arduino to active buzzer
